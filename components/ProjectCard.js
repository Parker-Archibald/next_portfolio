...
const ProjectCard = ({image, projectName, position, tech, points, link}) => {
    return (
        <article className="flex flex-col items-center rounded-lg space-y-7 flex-shrink-0 w-[350px] snap-center bg-gray-800 p-10 
        hover:opacity-100 md:opacity-40 cursor-pointer transition-opacity
        duration-200 overflow-hidden md:w-[600px]" onClick={() => window.open(link)}>
            <motion.img 
